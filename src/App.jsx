...
// Smart Hub Imports
import SmartHubLayout from './components/layout/SmartHubLayout';
import StudentDashboard from './pages/student/StudentDashboard';
import SubjectsHub from './pages/student/SubjectsHub';
import QuizSystem from './pages/student/QuizSystem';
import MarksPortal from './pages/student/MarksPortal';
  ...
  return (
    <AuthProvider>
      <Router>
        ...
        {!showSplash && (
          <Routes>
            {/* Smart Hub Routes (New Premium Interface) */}
              ...
              <div className={darkMode ? 'dark' : ''}>
                <SmartHubLayout>
                  <Routes>
                    ...
                    <Route path="/marks" element={<MarksPortal />} />
                  ...
                  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                      ...
                      <div className="flex items-center gap-4">
                        <Link to="/hub" className="text-sm font-bold text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 transition-colors bg-indigo-50 dark:bg-indigo-500/10 px-4 py-2 rounded-full">
                          Enter Smart Hub
                        </Link>
